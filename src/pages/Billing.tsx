...
import { ClientPaymentMethodsManager } from "@/components/billing/ClientPaymentMethodsManager";
import { PlatformPaymentInfo } from "@/components/billing/PlatformPaymentInfo";
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="font-medium text-foreground">
                        {subscriberCount} /{" "}
                        {getSubscriberLimit() < 0 ? "∞" : getSubscriberLimit().toLocaleString()}
                      </span>
                    </div>
                    <Progress
                      value={
                        getSubscriberLimit() < 0
                          ? 0
                          : (subscriberCount / getSubscriberLimit()) * 100
                      }
                      className="h-2"
                    />
                  </div>
                    ...
                    <CardHeader className="text-center pb-2">
                      ...
                      <CardDescription>
                        ...
                        {plan.max_subscribers < 0
                          ? "Unlimited"
                          : plan.max_subscribers.toLocaleString()}{" "}
                        subscribers
                      </CardDescription>
                    </CardHeader>
        ...
        <TabsContent value="history">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Your past transactions and payment records.
              </CardDescription>
            </CardHeader>
            <CardContent>
